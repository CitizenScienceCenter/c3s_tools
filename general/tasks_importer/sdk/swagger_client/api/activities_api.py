...
class ActivitiesApi(object):
    ...
    def delete_activity_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and not re.search('^[a-zA-Z0-9-]+$', params['id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `delete_activity`, must conform to the pattern `/^[a-zA-Z0-9-]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_activities_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'limit' in params and params['limit'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_activities`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_activity_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and not re.search('^[a-zA-Z0-9-]+$', params['id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `get_activity`, must conform to the pattern `/^[a-zA-Z0-9-]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_activity_count(self, **kwargs):  # noqa: E501
        """Get row count of query  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_activity_count(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_activity_count_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_activity_count_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_activity_count_with_http_info(self, **kwargs):  # noqa: E501
        """Get row count of query  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_activity_count_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_activity_count" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_activity(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_activity_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_activity_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def update_activity_with_http_info(self, id, **kwargs):  # noqa: E501
        """Modify/Create a Activity  # noqa: E501
        ...
        all_params = ['id', 'activity']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'id' in params and not re.search('^[a-zA-Z0-9-]+$', params['id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `update_activity`, must conform to the pattern `/^[a-zA-Z0-9-]+$/`")  # noqa: E501
        collection_formats = {}
